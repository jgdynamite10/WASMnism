    ...
    <div class="content-grid">
      ...
      <aside class="side-col">
        ...
        <div class="card info-card">
          ...
          <p class="info-desc">This gateway runs identically on Akamai Functions and AWS Lambda. The scorecard measures overhead across both platforms. To access the testing methodology and latest scorecard, <a href="https://github.com/jgdynamite/WASMnism/blob/ml-inference/docs/benchmark_contract_tier2.md" target="_blank" rel="noopener noreferrer">click here</a>.</p>
