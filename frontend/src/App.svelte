    ...
    <div class="content-grid">
      ...
      <aside class="side-col">
        ...
        <div class="card info-card">
          ...
          <p class="info-desc">This gateway runs identically on Akamai Functions, Fastly Compute, and Cloudflare Workers. The scorecard measures overhead across all three platforms. To access the testing methodology and latest scorecard, <a href="https://github.com/jgdynamite/WASMnism/blob/main/docs/benchmark_contract.md" target="_blank" rel="noopener">click here</a>.</p>
